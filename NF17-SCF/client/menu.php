<?php
	echo "<div class='menu'>
		    ...
		    {	
				...
				echo "<div style='display:none;' class='detail_compte' id='detail_compte'><div class='detail_identite'></div><b>".$prenom." ".$nom."</b><br>".$tel."<br><br><a href='historique.php'>Historique</a><br><br><a href='../login/deconnexion.php'>Déconnexion</a></div>";
