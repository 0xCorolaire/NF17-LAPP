...
<?php
	...
	if(!$correspondance){
		...
		//////////////////////////// Création du billet ////////////////////////////
		$insertion_billet = "INSERT INTO billet(fk_voyocc,fk_voyreg,mode_paiment,assurance,etat,date_depart,date_arrivee) VALUES ($id_voyageur,$id_voyageur2,'$paiement',$assurance, 'payé','$date_depart','$date_depart')";
        $resultset8 = $connexion->prepare($insertion_billet);
		$resultset8->execute();

		//////////////////////////// Création du trajet ////////////////////////////
		$insertion48 = "INSERT INTO trajet(fk_billet,fk_arret_depart,fk_arret_arrivee,classe, date_depart, date_arrivee) VALUES ($id_billet,$row4[id_arret],$row7[id_arret], $classe1, '$date_depart','$date_depart')";
	...
	if($correspondance){
	   ...
	   $telephone=$_SESSION['telephone'];
		...
		$insertion48 = "INSERT INTO trajet(fk_billet,fk_arret_depart,fk_arret_arrivee,classe, date_depart, date_arrivee) VALUES ($id_billet,$row4[id_arret],$row5[id_arret], $classe1, '$date_depart','$date_depart')";
		$resultset48 = $connexion->prepare($insertion48);
		$resultset48->execute();

		//////////////////////////// Création du trajet 2 ////////////////////////////
		$insertion46 = "INSERT INTO trajet(fk_billet,fk_arret_depart,fk_arret_arrivee,classe, date_depart, date_arrivee) VALUES ($id_billet,$row6[id_arret],$row7[id_arret], $classe2, '$date_depart','$date_depart')";
